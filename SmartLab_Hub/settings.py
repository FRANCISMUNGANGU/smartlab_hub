...
DEBUG = True
ALLOWED_HOSTS = ["*"]
CSRF_TRUSTED_ORIGINS = ['https://*.ngrok-free.app', 'http://localhost:8000', 'http://127.0.0.1:8000']
...
ROOT_URLCONF = 'SmartLab_Hub.urls'
...
WSGI_APPLICATION = 'SmartLab_Hub.wsgi.application'
